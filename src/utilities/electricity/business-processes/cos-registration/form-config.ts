...
export const cosRegistrationFormGroups: FormGroupDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      // ---- Old Supplier ----
      { id: 'oldSupplierRoleCode',       label: 'Old Supplier Role Code',       type: 'text', required: true, defaultValue: 'X' },
      { id: 'oldSupplierParticipantId',  label: 'Old Supplier Participant ID',  type: 'text', required: true },
      // ---- Distributor / MPAS ----
      { id: 'distributorRoleCode',       label: 'Distributor / MPAS Role Code',       type: 'text', required: true },
      { id: 'distributorParticipantId',  label: 'Distributor / MPAS Participant ID',  type: 'text', required: true },
      // ---- Distributor / MPAS ----
      { id: 'mpasRoleCode',              label: 'Distributor / MPAS Role Code',       type: 'text', required: true },
      { id: 'mpasParticipantId',         label: 'Distributor / MPAS Participant ID',  type: 'text', required: true },
      // ---- MOP ----
