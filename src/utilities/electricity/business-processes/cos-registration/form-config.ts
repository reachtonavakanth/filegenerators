...
export const cosRegistrationFormGroups: FormGroupDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: '001',
        maxLength: 3,
        helpText: '3-digit MTC code — D0217 492[22] / D0260 492[9]',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: '📋',
    repeatable: true,
    blockLabel: 'Meter Group',
    addLabel: 'Add Another Meter Group',
    fields: [
      {
        ...
        placeholder: '00001',
        maxLength: 5,
        helpText: 'D0149 778[0] — 5-digit TPR code',
      },
      {
        id: 'meterType',
        label: 'Meter Type',
      ...
      },
      {
        ...
        helpText: 'D0149 283[0] / D0150 290[0]',
      },
      {
      ...
      },
      {
        ...
        required: true,
        placeholder: '200/5',
        helpText: 'D0150 291[0] — e.g. 200/5 or 1 for NHH',
      },
      {
        id: 'meterLocation',
      ...
      },
      {
        ...
        type: 'date',
        required: true,
        helpText: 'D0150 290[24]',
      },
    ],
    innerRepeatable: {
      id: 'registers',
      label: 'Register',
      addLabel: 'Add Another Register',
      fields: [
        {
          id: 'registerId',
          label: 'Register ID',
